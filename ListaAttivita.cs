...
{
    // Classe che implementa l'interfaccia IAttivitaManager per gestire le attività
    public class ListaAttivita : IAttivitaManager
    {
        private List<string> toDoList = new List<string>();   // Lista delle attività da fare
        private Random random = new Random();                 // Oggetto Random per generare suggerimenti casuali
        private List<string> suggerimenti = new List<string>  // Lista di suggerimenti predefiniti
        {
        ...
        // Metodo per visualizzare tutte le attività presenti nella lista
        ...
        // Metodo per modificare un'attività esistente nella lista
        ...
        // Metodo per rimuovere un'attività esistente dalla lista
        ...
        // Metodo per fornire un suggerimento casuale di attività
