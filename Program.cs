namespace ProgettoFinale
{
    class Programma
    {
        static void Main()
        {
            ...
            Console.Clear();
            string benvenuto = $"Benvenuto {nome} {cognome} nella Console App di Alessandro Foggetti, cosa desideri fare?";
